...
public class EmVentaServicio {
	...
	public String mostrarFormulario(Model model) {
		...
		return "em_registro_venta_servicio";
	...
	public String guardarServicio(@RequestParam("servi") Integer idServicio, @RequestParam("cliente") Integer idCliente,
		...
		return "redirect:/em/ventaServicio/nuevo";
	...
	public String mostrarListaVenta(Model model) {
		...
		return "em_lista_venta_servicio";
